...
puts "Travail : #{number_of_hours_worked_per_day * number_of_days_worked_per_week * number_of_weeks_in_THP}" # multiplication des 3 valeurs précédentes puis affiche l'argument sur une ligne suivie d'un retour à la ligne
